...
import { Mail, Github, Linkedin, Facebook, Instagram, Sun, Moon } from "lucide-react";
      ...
      <div className="absolute w-72 h-72 bg-blue-500/20 dark:bg-blue-400/10 blur-3xl rounded-full -z-10"></div>
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              ...
              and passionate <span className="text-blue-600 font-medium">app developer</span>. I love combining technology and creativity to solve real-world problems.  
              From developing innovative apps to exploring smart grid research. I thrive on turning ideas into impactful solutions. My goal is to continually learn, create, and contribute to projects that make a difference.
            </p>
      ...
      <section id="contact" className="py-16 px-6 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 mb-8">
            {[{
              href: "mailto:chaudharysantosh03k@gmail.com",
              icon: <Mail size={24} />,
              label: "Email",
              bgHover: "hover:bg-blue-600 hover:text-white"
            },
            {
              href: "https://github.com/nishant01k",
              icon: <Github size={24} />,
              label: "GitHub",
              bgHover: "hover:bg-gray-900 hover:text-white"
            },
            {
              href: "https://linkedin.com/in/santosh-kumar-chaudhary-06baa9350",
              icon: <Linkedin size={24} />,
              label: "LinkedIn",
              bgHover: "hover:bg-blue-700 hover:text-white"
            },
            {
              href: "https://facebook.com/santosh01k",
              icon: <Facebook size={24} />,
              label: "Facebook",
              bgHover: "hover:bg-blue-600 hover:text-white"
            },
            {
              href: "https://instagram.com/nishant_01k?igsh=ZGprempmcnZ1aTdy",
              icon: <Instagram size={24} />,
              label: "Instagram",
              bgHover: "hover:bg-pink-500 hover:text-white"
            }].map((item) => (
              <motion.a
                key={item.label}
                href={item.href}
